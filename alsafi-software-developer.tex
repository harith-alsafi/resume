...
\cvevent{Fullstack Engineer}{BT Group}{Sep 2024 - Ongoing}{Manchester, UK}
\begin{itemize}
% \item Designed and implemented multithreaded Java Spring Boot REST APIs with MongoDB and PostgreSQL
% \item Automated deployments using Docker, Pulumi and AWS services, including IAM, VPC, and EC2
% \item Mentored apprenticeship students on backend software design while assessing readiness for advanced training.
% \item Built and maintained internal tools with React.js to enhance backend system monitoring and team productivity.
% \item Organized and managed regional Grad network events, fostering professional development and collaboration
\item Architected high-performance REST APIs using Java Spring Boot with MongoDB achieving 99.9 \% uptime 
\item Implemented deployment architecture using Pulumi, Kafka and AWS improving response time by 60 \% 
\item Established mentorship program for apprenticeship students, resulting in 90 \% pass rate for training assessments
\item Led regional Grad network initiatives, organizing monthly tech talks and workshops with 50+ regular attendees
\end{itemize}
\tightdivider
...
\cveducation{BEng (Hons) in Electronics and Computer}{University of Leeds (UoL)}{Sept 2019 - June 2024}{First-Class Honors (80 \%)}
\begin{itemize} 
...
\cvevent{Vega: LLM-driven Intelligent Chatbot Platform for Internet of Things Control and Development}{Pending publication - 1\textsuperscript{st} Author}{2024}{}
\begin{itemize}
