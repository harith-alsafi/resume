...
\begin{itemize}
\item Delivered 5 Kafka-based Spring Boot microservices with MongoDB/PostgreSQL, Netflix Conductor, and Pulumi
\item Mentored and examined 5+ apprentices on agile development with Java Spring Boot and AWS Lambda
\item Achieved 30\% AWS cost reduction by automating infrastructure with TypeScript and optimizing ECS cluster usage
\item Re-architecture Spring Boot APIs with JWT, Azure AD, and role-based access achieving enterprise grade security
...
\item Developed Serverless REST API with C\# and Azure for IoT Sensors and analytics using SQL Triggers and Binding
...
\begin{itemize}
\item Architected scalable file server infrastructure using Apache, Nextcloud, and Ubuntu in production environment
\item Automated system administration workflows using Python, Bash scripting, and network security protocols
\item Developed high-availability load balancer with C/MPI achieving 34\% improved system uptime
\item Built predictive analytics pipeline using Python for proactive cybersecurity threat detection
...
\begin{itemize}
  ...
  \item Programmed language processing algorithms using multi-modal large language models to interpret and execute messages 
  \item Implemented a Python Flask REST Server with SQLite on the Raspberry Pi to communicate with the chat bot
  \item Engineered a circuit with sensors, camera, fans, LCD and buttons to execute the user's commands from the chat bot 
  \end{itemize}
