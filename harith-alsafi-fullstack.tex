...
\begin{itemize}
  \item Developed a full stack Chatbot web application with TypeScript, React.js, Next.js, TailwindCSS and Reddis
  \item Programmed language processing algorithms using multi-modal large language models to execute user messages
  \item Implemented a Python Flask REST Server with SQLite on the Raspberry Pi to communicate with the chatbot
  \item Engineered a circuit with sensors, camera, fans, LCD and buttons to execute user's commands from the chatbot 
  \end{itemize}
...
\item Designed Firestore real-time database with Zustand state and Zod validation for seamless data syncing
\end{itemize}
\tightdivider

%% // TODO: finalize this
\cvevent{Green ML: Machine Learning for Green Bond Syndication}{}{Apr 2021 - Oct 2021 \quad \faMapPin \ \ Personal}{}
\begin{itemize}
\item a
\item b
\item c
