...
A Software Engineer with \textbf{5 years} of specializing in Machine Learning, React.js, Java Spring Boot and Cloud Technologies. Proven record in leading technical teams, and driving cost optimizations across \textbf{startup} to \textbf{enterprise}.
...
\item Mentored and examined 5+ apprentices on agile development with \textbf{Java 21} Spring Boot and \textbf{AWS Lambda}
...
\cvevent{Machine Learning Engineer}{Paperound - Freelane}{Dec 2021 - May 2022 (6 Months)}{Leeds, UK}
...
\item Developed \textbf{signal processing filters} and modulators using SciPy Python and Fourier analysis for RF signals 
...
\item Built and trained a \textbf{reinforcement neural network} using TensorFlow, KerasRL for predicting market movements
\item Applied \textbf{data visualization} using Python Matplotlib to present analytical insights to non-technical stakeholders
\item Built production-ready \textbf{LLM \& RAG} inference APIs with Docker and Flask for low-latency model serving.
...
\item Designed \textbf{text embedding and reranking} using HuggingFace to score resumes against job descriptions
\end{itemize}
\tightdivider
